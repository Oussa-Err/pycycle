...
from form_stagire import GestionStagire
class FormAdmin:
    def __init__(self):
        self.root=tk.Tk()
        ...
        self.btnGestFormateur=tk.Button(self.root,text="Gestion de Formateur",width=20)
        self.btnGestFormateur.pack()
        self.btnGestAdmin=tk.Button(self.root,text="Gestion de Admin",width=20)
